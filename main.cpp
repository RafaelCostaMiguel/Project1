...
protected:
    ...
    int idade;
public:
    Pessoa(string nome, char genero, int idade) {
        this->nome = nome;
        this->genero = genero;
        this->idade = idade;
	}
...
public:
    Medico(string especialidade, int crm)
    {
    ...
    void exibirInfo() const override {
        cout << "Médico [" << id << "] Nome: " << nome << ", Idade: " << idade
...
public:
    ...
    void exibirInfo() const override {
        cout << "Paciente [" << id << "] Nome: " << nome << ", Idade: " << idade
            << ", Leito: " << (idLeito == -1 ? "Nenhum" : to_string(idLeito)) << endl;
    }
};
...
class Leito {
    ...
    bool ocupado;
public:
    Leito(int id) : id(id), ocupado(false) {}
    ...
    void exibirInfo() const {
        cout << "Leito [" << id << "] Status: " << (ocupado ? "Ocupado" : "Livre") << endl;
    }

    // Polimorfismo por sobrecarga
    bool operator==(const Leito& outro) const {
